...
object MainBackgroundPolicy {
     ...
     *
     * Замена анимации — **пустой фон**, а не фактура. Устройства, которые не
     * тянут анимацию, — это старые телефоны, и полноэкранный растр стоит им
     * заметно дороже пустоты: его надо построить, держать в памяти и
     * перерисовывать под всем остальным. Фактура при этом никуда не делась, она
     * остаётся третьим вариантом в настройках — просто её теперь выбирают, а не
     * получают молча вместо анимации.
     */
