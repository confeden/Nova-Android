...
object RussianDirectApps {
    ...
    private val OTHER: Set<String> = setOf(
        ...
        // --- Шеринг самокатов и велосипедов ---
        //
        // Причина та же, что у такси и каршеринга: поездку заводит сервис,
        // привязанный к российскому адресу и к оплате российской картой.
        "ru.urentbike.app",                // Юрент
        "com.punicapp.whoosh",             // Whoosh

        // --- Учёба и профсоюз ---
        //
        // Оба входят по учётной записи российской организации и с зарубежного
        // адреса упираются в лишние подтверждения.
        "com.ustasapp",                    // УрФУ.Учёба
        "com.dlilb.profplus",              // ПрофПлюс (профсоюз образования)
